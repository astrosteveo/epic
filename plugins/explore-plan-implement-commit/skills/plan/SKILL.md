...
Transform design into action. This skill takes the architecture from `design` and creates a step-by-step implementation plan with structured task templates that the Coder subagent can execute without additional exploration.
